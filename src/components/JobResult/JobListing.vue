<template>
      <li class="mb-7">
        <router-link :to="jobPageLink" class="mx-auto block rounded border border-solid border-brandGray-2 bg-white hover:shadow-gray">
          <div class="mx-8 border-b border-solid border-brandGray-2 pt-5 pb-2">
          ...
          <div class="px-8 py-4">
            ...
            <div class="mt-2 text-center">
              <router-link :to="jobPageLink" class="text-brandBlue-1">Expand</router-link>
            </div>
